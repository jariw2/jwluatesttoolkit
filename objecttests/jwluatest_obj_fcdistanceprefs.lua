function FCDistancePrefs_ValueTests_ItemNo1(distanceprefs)
   ...
   NumberValuePropertyTest(distanceprefs, "FCDistancePrefs", "AccidentalMultiSpace", 8)
   NumberValuePropertyTest(distanceprefs, "FCDistancePrefs", "AccidentalNoteSpace", 8)
